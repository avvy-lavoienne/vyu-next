...
## Overview
Crypto Blue is a fintech-grade design system built for the digital asset era. It pairs a bold, trustworthy blue (#0052FF) with an elegant soft purple accent (#B49FCC) and refined dark and light neutrals to convey security, modernity, and premium sophistication. The aesthetic is minimal, data-rich, and engineered for clarity in financial interfaces where every pixel of information matters. The purple accent adds a touch of luxury and innovation, perfect for highlighting premium features, exclusive assets, or elevated user actions without overpowering the core blue identity.
...
- **Accent** (#B49FCC): Elegant highlights, premium features, special CTAs, luxury indicators, and exclusive asset badges — Soft Lavender
...
**Accent tint for backgrounds**: #F5F0FA (light lavender for subtle premium chips or banners)
...
## Components
- **Buttons**: 44px height, 20px horizontal padding, 8px border-radius, DM Sans 700 at 15px. Primary: #0052FF bg, white text. Accent: #B49FCC bg, white text (for premium or elevated actions). Secondary: white bg, #050F1A text, 1px #D1D5DB border. Ghost: transparent bg, #0052FF text (or #B49FCC for accent ghost). Disabled: 40% opacity. Minimum width 100px.
- **Cards**: White background, 1px #D1D5DB border, 12px border-radius, 20px padding. Asset cards show a left-aligned icon (32px), name, ticker, and right-aligned price with 24h change chip. Hover: border-color #0052FF. Premium / featured cards: subtle left border or top accent stripe in #B49FCC, or hover border #B49FCC for exclusive assets.
...
- **Chips**: 28px height, 10px horizontal padding, 6px border-radius, 13px text. Positive: #E6F6EF bg, #05B169 text. Negative: #FDECEE bg, #DF2935 text. Neutral: #F3F4F6 bg, #5B616E text. Premium / Elegant: #F5F0FA bg, #B49FCC text (for VIP status, exclusive badges, or special labels).
...
- **Navigation**: Top bar 60px height, white bg, bottom 1px #D1D5DB border. Logo left, horizontal nav center (DM Sans 500, 15px), portfolio/trade CTA right. Active nav: #0052FF text, 2px bottom border. Premium CTAs (e.g., "Upgrade" or "Pro"): use Accent #B49FCC for visual distinction.
...
- Do use the elegant accent (#B49FCC) sparingly for premium features, exclusive badges, VIP indicators, and elevated CTAs to add sophistication without diluting the primary blue hierarchy
- Don't overuse the purple accent (#B49FCC) — it should highlight special elements, not compete with primary actions or data
...
- Do pair #0052FF and #B49FCC harmoniously in gradients or dual-tone elements for a modern, premium fintech feel (e.g., blue-to-purple gradients on hero sections or special asset cards)